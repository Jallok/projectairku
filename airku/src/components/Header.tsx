...
export default function Header() {
  ...
  return (
    <nav className="container flex justify-between items-center h-[98px] fixed top-0 bg-background z-10 shadow-md shadow-black">
      <div className="ml-[100px] top-[23px] justify-center items-center gap-[17px] inline-flex">
