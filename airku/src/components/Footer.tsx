...
export default function Footer() {
  ...
  return (
    <div className="flex flex-col justify-between items-center bg-background mt-[109px] h-[468px] shrink-0">
      <div className="h-[267px] mt-[100px] justify-start items-start gap-[88px] inline-flex">
        <div className="h-[253px] flex-col justify-start items-start gap-[35px] inline-flex w-[339px]">
          <div className="inline-flex items-center gap-[17px]">
            <span className="w-[50px] h-[52px] relative">
              <Image src="/assets/airku.png" alt="logo" fill />
            </span>
            <p className="text-neutral-300 text-[32px] font-semibold leading-[120%] tracking-[-0.96px]">
              AIRKU
            </p>
          </div>
        ...
        <div className="">
          <span className="font-bold text-lg text-neutral-400 leading-[25.20px]">
            Useful Links
          </span>
          <span className="flex flex-col gap-6 leading-snug mt-4 text-neutral-300">
        ...
        <div className="w-[323px] h-[77px] flex-col justify-start items-start gap-[19px] inline-flex">
          <span className="font-bold text-lg leading-[25.20px] text-neutral-400">
            Connect With Us
          </span>
          <div className="flex justify-between gap-6 text-neutral-300">
      ...
      <div className="w-[215px] h-5 mb-[37px] justify-start items-end gap-1.5 inline-flex">
